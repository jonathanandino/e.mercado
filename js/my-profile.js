document.addEventListener("DOMContentLoaded", function(){
    ...
    if (user){
        ...
        if (usuario[0].given_name){
            document.getElementById("name").setAttribute("value", usuario[0].given_name)
        }
        if (usuario[0].family_name){
            document.getElementById("lastName").setAttribute("value", usuario[0].family_name)
        }
        if (usuario[0].email){
